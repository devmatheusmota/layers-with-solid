...
test('Deve criar uma transacao', async () => {
	const connection = new PostgreSQLAdapter();
	// const transactionRepository = new TransactionDatabaseRepository(connection); // Teste com banco de dados
	const transactionRepository = new TransactionMemoryRepository(); // Teste com banco de dados em memoria
